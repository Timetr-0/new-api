...
func TestDoAwsClientRequest_PassesThroughUnknownAnthropicBeta(t *testing.T) {
	t.Parallel()
	...
	info := &relaycommon.RelayInfo{
		...
		UseRuntimeHeadersOverride: true,
		RuntimeHeadersOverride: map[string]any{
			"anthropic-beta": "feature-probe-2026-07-23,computer-use-2025-01-24",
		},
		ChannelMeta: &relaycommon.ChannelMeta{
			ApiKey:            "access-key|secret-key|us-east-1",
			UpstreamModelName: "claude-3-5-sonnet-20240620",
	...
	values, ok := anthropicBeta.([]any)
	require.True(t, ok)
	require.Equal(t, []any{"feature-probe-2026-07-23", "computer-use-2025-01-24"}, values)
}
