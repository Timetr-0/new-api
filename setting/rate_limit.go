...
func InitAwsBedrockRateLimitEnv() {
	...
	AwsBedrockRateLimitQueueMaxSize = common.GetEnvOrDefault("AWS_BEDROCK_RATE_LIMIT_QUEUE_MAX_SIZE", 0)
	if AwsBedrockRateLimitQueueMaxSize < 0 {
