...
func TestAwsBedrockGlobalClaudeRatios(t *testing.T) {
	...
	tests := []struct {
		...
		{"global.anthropic.claude-opus-5", 2.5},
	}
...
func TestAwsBedrockClaude5Ratios(t *testing.T) {
	InitRatioSettings()
	...
	tests := []struct {
		...
		{"eu.anthropic.claude-sonnet-5", 1.1},
		{"au.anthropic.claude-sonnet-5", 1.1},
		{"global.anthropic.claude-sonnet-5", 1},
		{"claude-opus-5", 2.75},
		{"anthropic.claude-opus-5", 2.75},
		{"us.anthropic.claude-opus-5", 2.75},
		{"eu.anthropic.claude-opus-5", 2.75},
		{"au.anthropic.claude-opus-5", 2.75},
		{"global.anthropic.claude-opus-5", 2.5},
	}
